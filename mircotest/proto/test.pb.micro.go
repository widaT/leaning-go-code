...
type SayService interface {
	Hello(ctx context.Context, in *Request, opts ...client.CallOption) (*SayResponse, error)
}
...
func (c *sayService) Hello(ctx context.Context, in *Request, opts ...client.CallOption) (*SayResponse, error) {
...
type SayHandler interface {
	Hello(context.Context, *Request, *SayResponse) error
}

func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		Hello(ctx context.Context, in *Request, out *SayResponse) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) Hello(ctx context.Context, in *Request, out *SayResponse) error {
